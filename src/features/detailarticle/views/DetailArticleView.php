...
<article class="container mx-auto mb-10 max-w-4xl px-6 py-10 bg-white shadow-lg rounded-xl mt-10">
  <header class="mb-6">
  ...
  <div class="mb-6">
    <img src="<?= htmlspecialchars("/uploads/" . $article['picture']); ?>" alt="Image" class="w-full h-96 object-cover rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
  </div>
...
<a href="/" class="px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition">
